...
type NavProp = StackNavigationProp<RootStackParamList, 'Uploads'>;
        ...
        {filtered.length === 0 ? (
          <View style={styles.emptyWrap}>
            ...
            <Text style={styles.emptySub}>
              Add patients first to manage their documents.
            </Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  safeArea: {flex: 1, backgroundColor: ORANGE_COLOR},
  centered: {
    flex: 1,
  ...
  rowAvatarText: {fontSize: 15, fontWeight: '700', color: ORANGE_COLOR},
  rowBody: {flex: 1},
